      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <Select value={type} onValueChange={onTypeChange}>
            ...
            <SelectContent>
              ...
              <SelectItem value="data-pack">Датапак</SelectItem>
              <SelectItem value="skin">Скин</SelectItem>
              <SelectItem value="shader">Шейдер</SelectItem>
              <SelectItem value="modpack">Сборка модов</SelectItem>
              <SelectItem value="shader-pack">Сборка шейдеров</SelectItem>
              <SelectItem value="resource-pack-collection">
                Сборка ресурс-паков
              </SelectItem>
              <SelectItem value="complete-pack">Полная сборка</SelectItem>
        ...
        <div>
          ...
          {!thumbnailPreview && (
            <Alert className="bg-red-50 border-red-200 mt-2">
              <AlertDescription className="text-red-700">
                Обложка является обязательной. Пожалуйста, загрузите
                изображение.
              </AlertDescription>
            </Alert>
          )}
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Рекомендуемый размер: 1280x720 или 16:9. Максимальный размер файла:
            5MB.
          </p>
        </div>
      </div>
